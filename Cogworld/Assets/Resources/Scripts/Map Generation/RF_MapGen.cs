...
public class RF_MapGen : SRW_MapGen
{
    [SerializeField] private int minRoomWidth = 4, minRoomHeight = 4;
    [SerializeField] private int dungeonWidth = 20, dungeonHeight = 20;
    [SerializeField] [Range(0, 10)] private int offset = 1; // Ensure that there are wall separating the rooms
    [SerializeField] private bool randomWalkRooms = false; // Check if we want to use RandomWalk to generate


    protected override void RunProceduralGeneration()
    {
        startPosition.y = -1 * dungeonHeight / 2;
        startPosition.x = -1 * dungeonWidth / 2;
        CreateRooms();
    }
